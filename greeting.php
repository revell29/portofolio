...
<body>
    <div>
        ...
        <div class="twinkling">
            <div class="container" style="z-index: 100;">
                    ...
                    <div class="col-md-6" id="form-view">
                        <form action="">
                            <div class="form-group">
                                <label for="" class="text-white">Hello, Saya milo :)</label>
                ...
                <div class="" id="greeting" style="display: none; margin-top: -80px;">
                    <div class="text-center">
                        <h5 id="greeting-text" style="font-size: 3em; color: white;"></h5>
                        <h5 id="name-tf" style="font-size: 3em; color: white;"></h5>
                        <img src="https://thumbs.gfycat.com/EthicalMadDove-max-1mb.gif" alt="" style="height: 400px; width: auto;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $("#submit").on("click", function() {
            ...
            $('#name-tf').html(name + ' Selamat Istirahat');
        });
    </script>
</body>
